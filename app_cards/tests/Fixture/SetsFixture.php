...
class SetsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'legallity' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'image_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'brand' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'date' => '2016-06-17',
            'size' => 1,
            'legallity' => 'Lorem ipsum dolor sit ame',
            'image_id' => 1,
            'brand' => 'Lorem ipsum dolor sit ame'
        ],
    ];
}
